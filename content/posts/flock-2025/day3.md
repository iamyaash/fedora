...
{{< figure src="/fedora/posts/flock-2025/img/day3/lunch-1.jpg" 
    alt="Lunch 1" 
    width="100%" 
>}}

{{< figure 
    src="/fedora/posts/flock-2025/img/day3/lunch-2.jpg" 
    title="Enjoying Delicious Desserts After Lunch" 
    caption="While waiting in line for lunch, I spotted these desserts. After enjoying my meal, I grabbed some, they were amazingly delicious, unlike anything I've tasted before!" 
    alt="Tasty desserts" 
    width="100%" 
>}}
...
{{< figure 
    src="/fedora/posts/flock-2025/img/day3/distgit.jpg" 
    title="Distgit implementation in Forgejo By Tomáš Hrčka" 
    caption="The session began with this image, which was generated by AI in response to Tomáš’s prompt: 'Generate Distgit'" 
    width="100%" 
>}}
...
{{< figure 
    src="/fedora/posts/flock-2025/img/day3/gpd-win.jpg" 
    title="GPD-Pocket" 
    caption="This is the GPD Pocket, which was launched around 2017. I used to watch YouTube reviews of this device, and I was really excited to see it in real life. It actually belonged to David Kirwan, and I borrowed it for a few minutes. It was amazing to see such a compact computer running GNOME, it was both impressive and really cool!" 
    width="100%" 
>}}
...
{{< figure 
    src="/fedora/posts/flock-2025/img/day3/last-session.jpg" 
    title=" Improve the Infrastructure applications By Aurélien Bompard" 
    width="100%" 
>}}
...
{{< figure 
    ...
    title=" Fedora Infrastructure Applications In A Nutshell " 
    width="100%" 
>}}
...
After that, I met [Vipul Siddharth](https://fedoraproject.org/wiki/User:Siddharthvipul1). He was very friendly and introduced himself. It turns out he was involved with the Fedora Project in the past, and now he works with UNICEF.
...
{{< figure 
    src="/fedora/posts/flock-2025/img/day3/waiting-tram.gif" 
    title="Waiting for the Tram to Arrive." 
    caption="The city was busy with people walking around, drizzling, and a street orchestra playing nearby. It was a truly lovely atmosphere."
>}}
...
{{< figure 
    src="/fedora/posts/flock-2025/img/day3/tram-station.gif" 
    title="Krematorium Motol, Praha" 
    caption="I missed my stop (or maybe I didn’t know how to open the tram door), so I had to walk to my hotel."
    width="100%" 
>}}

{{< figure 
    src="/fedora/posts/flock-2025/img/day3/otw-back.gif" 
    title="" 
    caption="Walking to the Hotel."
    width="100%" 
>}}
